...
REM Assumes mcp-coder-utils is editable-installed (pip install -e .)
...
set "EDITABLE_OK=0"
for /f "delims=" %%L in ('pip show mcp-coder-utils 2^>nul') do (
...
if "!EDITABLE_OK!"=="0" (
    echo WARNING: mcp-coder-utils does not appear to be editable-installed from %CD%
