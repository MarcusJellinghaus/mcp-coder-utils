...
- **New MCP server permissions**: 12 obsidian-wiki tool permissions and 1 workspace tool permission added, enabling Claude to use these tools without per-call approval when the servers are configured.
...
| `.claude/settings.local.json` | Append 13 new permissions to `allow` array |
